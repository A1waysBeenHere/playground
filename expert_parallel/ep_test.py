...
# torchrun --nproc_per_node=2 ep_test.py --ep_enabled True
...
from modeling_dummy import MoEModel, Attention
...
def parse_args():
    ...
    parser.add_argument("--ep_enabled", type=bool, default=False, help="Ulysses parallel trigger")
